...
#include "GAS/GA/Player/PlayerEquipSecondaryWeaponGameplayAbility.h"
	...
	const FGameplayEventData* TriggerEventData)
{
	...
	ABaseWeapon* TargetWeapon = PlayerCombatComponent->GetCharacterCarriedWeaponByTag(MGSGameplayTags::Weapon_Secondary);
