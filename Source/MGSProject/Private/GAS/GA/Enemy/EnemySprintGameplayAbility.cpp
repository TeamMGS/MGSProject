/*
 * 파일명 : EnemySprintGameplayAbility.cpp
 * 생성자 : 장대한
 * 생성일 : 2026-03-12
 * 수정자 : 장대한
 * 수정일 : 2026-03-12
...
#include "GAS/GA/Enemy/EnemySprintGameplayAbility.h"
...
bool UEnemySprintGameplayAbility::CanActivateAbility(const FGameplayAbilitySpecHandle Handle,
...
void UEnemySprintGameplayAbility::ActivateAbility(const FGameplayAbilitySpecHandle Handle,
	const FGameplayAbilityActorInfo* ActorInfo,
	...
	const FGameplayEventData* TriggerEventData)
{
	...
	{
		bApplied = EnemyCharacter->SetSprintMovementMode();
	}
