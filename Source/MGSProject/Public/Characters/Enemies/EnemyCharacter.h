...
protected:
	...
	bool ApplyEnemyMovementMode(const FGameplayTag& NewMovementStateTag, float NewMaxWalkSpeed);
...
protected:
	...
	UPROPERTY(VisibleAnywhere, BlueprintReadOnly, Category = "AI|Movement", meta = (AllowPrivateAccess = true))
	FGameplayTag CurrentEnemyMovementStateTag;
	// Default speed
	UPROPERTY(EditDefaultsOnly, BlueprintReadOnly, Category = "AI|Movement", meta = (AllowPrivateAccess = true, ClampMin = "0.0"))
	...
	// Head Collision
	// Size
	UPROPERTY(EditDefaultsOnly, BlueprintReadOnly, Category = "Combat|Damage", meta = (AllowPrivateAccess = true, ClampMin = "0.0"))
	float HeadHitSphereRadius = 18.0f;
	// Damage scale
	UPROPERTY(EditDefaultsOnly, BlueprintReadOnly, Category = "Combat|Damage", meta = (AllowPrivateAccess = true, ClampMin = "1.0"))
